 ...
 * @subpackage tx_damcatedit
 */
class tx_damcatedit_cmd_nothing extends t3lib_extobjbase {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dam_catedit/mod_cmd/class.tx_damcatedit_cmd_nothing.php'])    {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dam_catedit/mod_cmd/class.tx_damcatedit_cmd_nothing.php']);
}
